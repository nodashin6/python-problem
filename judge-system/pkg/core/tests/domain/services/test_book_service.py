...
class TestBookDomainService:
    ...
    @pytest.mark.asyncio
    async def test_add_problem_to_book_success(
    ...
    @pytest.mark.asyncio
    async def test_add_problem_to_book_book_not_found(
    ...
    @pytest.mark.asyncio
    async def test_remove_problem_from_book_success(
        self, book_service, mock_problem_repo
    ):
        """問題集からの問題削除成功のテスト"""
        problem_id = uuid4()
        book_id = uuid4()
    ...
    @pytest.mark.asyncio
    async def test_get_book_with_problems(
        self, book_service, mock_book_repo, mock_problem_repo
    ):
        """問題集と問題の取得テスト"""
        book_id = uuid4()
        ...
        # テスト実行
        result_book, result_problems = await book_service.get_book_with_problems(
            book_id
        )
    ...
    @pytest.mark.asyncio
    async def test_delete_book_with_problems_error(
        self, book_service, mock_book_repo, mock_problem_repo
    ):
        """問題が含まれる問題集の削除エラーテスト"""
        book_id = uuid4()
