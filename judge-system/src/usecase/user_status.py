...
class UserStatusManager:
    ...
    def get_problem_status(
        self, problem_id: str, problem_set: str
        ...
        if key not in status:
            ...
            return models.UserProblemStatus(
                user_id=self.user_id, problem_id=problem_id, problem_set=problem_set
            )
        ...
        if isinstance(problem_status.get("solved_at"), str):
            problem_status["solved_at"] = datetime.fromisoformat(
    ...
    def update_problem_status(
        self,
        judge_response: models.JudgeProcessResponse,
        submission_id: str,
        problem_set: str,
    ):
        ...
        # 提出回数を更新
        problem_status["submission_count"] = (
            problem_status.get("submission_count", 0) + 1
        )
