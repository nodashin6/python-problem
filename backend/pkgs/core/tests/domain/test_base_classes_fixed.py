"""
Tests for Core Domain Base Classes - Fixed Version
コアドメイン基底クラスのテスト
"""
...
class TestBaseModel:
    ...
    def test_abstract_class(self):
        """Test that BaseModel requires all fields"""
        # BaseModel requires id, created_at, updated_at fields
    ...
    def test_model_validation(self):
        """Test that BaseModel validates field types"""
