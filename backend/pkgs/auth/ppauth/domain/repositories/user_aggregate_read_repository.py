...
class UserAggregateReadRepositoryBase(IReadAggregateRepository[User, ReadAggregateUserSchema]):
...
UserAggregateReadRepository = UserAggregateReadRepositoryBase
