...
class TestBookEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_get_books_success(self, app, client, mock_book_entity):
        """問題集一覧取得の成功テスト"""
        # モックの設定
        ...
        # 依存性注入をオーバーライド
        from ppprob.app.dependencies import get_read_published_books_usecase
        app.dependency_overrides[get_read_published_books_usecase] = lambda: mock_usecase
    ...
    @pytest.mark.asyncio
    async def test_get_book_success(self, app, client, mock_book_entity):
        """問題集詳細取得の成功テスト"""
        # モックの設定
        mock_usecase = AsyncMock()
        mock_result = Mock()
        ...
        # 依存性注入をオーバーライド
        from ppprob.app.dependencies import get_read_book_by_id_usecase
        app.dependency_overrides[get_read_book_by_id_usecase] = lambda: mock_usecase
    ...
    @pytest.mark.asyncio
    async def test_get_book_not_found(self, app, client):
        """問題集が見つからない場合のテスト"""
        # モックの設定
        mock_usecase = AsyncMock()
        mock_result = Mock()
    ...
    @pytest.mark.asyncio
    async def test_create_book_success(self, app, client, mock_book_entity):
        """問題集作成の成功テスト"""
        # モックの設定
        mock_usecase = AsyncMock()
        mock_result = Mock()
        ...
        # 依存性注入をオーバーライド
        from ppprob.app.dependencies import get_create_book_usecase
        app.dependency_overrides[get_create_book_usecase] = lambda: mock_usecase
...
class TestProblemEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_get_problems_all_success(self, app, client, mock_problem_entity):
        """全問題取得の成功テスト"""
        # モックの設定
        mock_usecase = AsyncMock()
        mock_result = Mock()
        ...
        # 依存性注入をオーバーライド（両方のusecaseが必要）
        from ppprob.app.dependencies import get_read_published_problems_usecase, get_read_problems_by_book_id_usecase
        app.dependency_overrides[get_read_published_problems_usecase] = lambda: mock_usecase
        app.dependency_overrides[get_read_problems_by_book_id_usecase] = lambda: AsyncMock()  # Dummy for dependency injection
    ...
    @pytest.mark.asyncio
    async def test_get_problems_by_book_id_success(self, app, client, mock_problem_entity):
        """問題集別問題取得の成功テスト"""
        # モックの設定
        mock_usecase = AsyncMock()
        mock_result = Mock()
        ...
        # 依存性注入をオーバーライド（両方のusecaseが必要）
        from ppprob.app.dependencies import get_read_problems_by_book_id_usecase, get_read_published_problems_usecase
        app.dependency_overrides[get_read_problems_by_book_id_usecase] = lambda: mock_usecase
        app.dependency_overrides[get_read_published_problems_usecase] = lambda: AsyncMock()  # Dummy for dependency injection
    ...
    @pytest.mark.asyncio
    async def test_get_problem_success(self, app, client, mock_problem_entity):
        """問題詳細取得の成功テスト"""
        # モックの設定
        mock_usecase = AsyncMock()
        mock_result = Mock()
        ...
        # 依存性注入をオーバーライド
        from ppprob.app.dependencies import get_read_problem_by_id_usecase
        app.dependency_overrides[get_read_problem_by_id_usecase] = lambda: mock_usecase
    ...
    @pytest.mark.asyncio
    async def test_get_problem_not_found(self, app, client):
        """問題が見つからない場合のテスト"""
        # モックの設定
        mock_usecase = AsyncMock()
        mock_result = Mock()
    ...
    @pytest.mark.asyncio
    async def test_create_problem_success(self, app, client, mock_problem_entity):
        """問題作成の成功テスト"""
        # モックの設定
        mock_usecase = AsyncMock()
        mock_result = Mock()
        ...
        # 依存性注入をオーバーライド
        from ppprob.app.dependencies import get_create_problem_usecase
        app.dependency_overrides[get_create_problem_usecase] = lambda: mock_usecase
