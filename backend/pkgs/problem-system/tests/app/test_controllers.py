...
class TestBookController:
    ...
    @pytest.mark.asyncio
    async def test_get_published_books_success(self, book_controller, mock_book_service):
        """公開済み問題集取得成功のテスト"""
        # モックの設定
        books = [
    ...
    @pytest.mark.asyncio
    async def test_get_book_by_id_service_error(self, book_controller, mock_book_service):
...
class TestProblemController:
    ...
    @pytest.mark.asyncio
    async def test_get_published_problems_success(self, problem_controller, mock_problem_service):
        """公開済み問題取得成功のテスト"""
        # モックの設定
        problems = [
            Problem(
    ...
    @pytest.mark.asyncio
    async def test_get_problem_by_id_success(self, problem_controller, mock_problem_service):
        """ID指定問題取得成功のテスト"""
        problem_id = uuid4()
        problem = Problem(
            id=problem_id,
    ...
    @pytest.mark.asyncio
    async def test_get_problem_by_id_not_found(self, problem_controller, mock_problem_service):
        """ID指定問題取得 (存在しない) のテスト"""
        problem_id = uuid4()
    ...
    @pytest.mark.asyncio
    async def test_get_problems_by_book_id_success(self, problem_controller, mock_problem_service):
        """問題集ID指定問題取得成功のテスト"""
        book_id = uuid4()
        problems = [
            Problem(
    ...
    @pytest.mark.asyncio
    async def test_get_problems_by_difficulty_success(self, problem_controller, mock_problem_service):
        """難易度指定問題取得成功のテスト"""
        problems = [
            Problem(
                title="Easy Problem",
        ...
        mock_problem_service.get_problems_by_difficulty.assert_called_once_with(DifficultyLevel.EASY)

    @pytest.mark.asyncio
    async def test_get_problems_by_difficulty_invalid(self, problem_controller, mock_problem_service):
        """無効な難易度指定のテスト"""
        # テスト実行とアサート
        with pytest.raises(HTTPException) as exc_info:
...
class TestJudgeCaseController:
    ...
    async def test_get_judge_cases_by_problem_id_success(
        ...
        mock_judge_case_service.get_judge_cases_by_problem_id.assert_called_once_with(problem_id)

    @pytest.mark.asyncio
    async def test_get_sample_cases_only_success(self, judge_case_controller, mock_judge_case_service):
        """サンプルケースのみ取得成功のテスト"""
        problem_id = uuid4()
        sample_cases = [
            JudgeCase(
        ...
        # モックの設定
        mock_judge_case_service.get_sample_cases_by_problem_id.return_value = sample_cases
        ...
        mock_judge_case_service.get_sample_cases_by_problem_id.assert_called_once_with(problem_id)

    @pytest.mark.asyncio
    async def test_get_judge_case_by_id_success(self, judge_case_controller, mock_judge_case_service):
        """ID指定ジャッジケース取得成功のテスト"""
        case_id = uuid4()
    ...
    @pytest.mark.asyncio
    async def test_get_judge_case_by_id_not_found(self, judge_case_controller, mock_judge_case_service):
...
class TestUserProblemStatusController:
    ...
    @pytest.mark.asyncio
    async def test_get_user_problem_status_success(self, status_controller, mock_status_service):
        """ユーザー問題状態取得成功のテスト"""
        user_id = uuid4()
        problem_id = uuid4()
        ...
        mock_status_service.get_user_problem_status.assert_called_once_with(user_id, problem_id)

    @pytest.mark.asyncio
    async def test_get_user_problem_status_not_found(self, status_controller, mock_status_service):
    ...
    @pytest.mark.asyncio
    async def test_get_user_solved_problems_success(self, status_controller, mock_status_service):
        """ユーザー解決済み問題取得成功のテスト"""
        user_id = uuid4()
        solved_statuses = [
            UserProblemStatus(
    ...
    @pytest.mark.asyncio
    async def test_get_user_progress_stats_success(self, status_controller, mock_status_service):
        """ユーザー進捗統計取得成功のテスト"""
        user_id = uuid4()
        stats = {
            "total_attempted": 10,
