...
class TestValueObjects:
    ...
    def test_user_profile_creation(self):
        """UserProfileの作成をテスト"""
        profile = UserProfile(display_name="Test User", bio="Test bio", github_username="testuser")
...
class TestProblem:
    ...
    def test_problem_creation(self):
        """問題作成をテスト"""
        author_id = uuid4()
        problem = Problem(title="Test Problem", description="Test description", author_id=author_id)
    ...
    def test_problem_acceptance_rate(self):
        """受理率計算をテスト"""
        problem = Problem(title="Test Problem", description="Test description", author_id=uuid4())
    ...
    def test_problem_publish(self):
        ...
        published_events = [e for e in problem._events if isinstance(e, ProblemPublished)]
...
class TestBook:
    ...
    def test_book_creation(self):
        """問題集作成をテスト"""
        book = Book(title="Test Book", description="Test description", author_id=uuid4())
